...
namespace TicketsRavelli.Application.Validators;

public class NewAthleteInputModelValidator : AbstractValidator<NewAthleteInputModel> {

    public NewAthleteInputModelValidator()
    {
        RuleFor(x => x.Nome)
            .NotEmpty()
            .NotNull()
