...
namespace TicketsRavelli.Application.Services.Implementations {
    public class RelatoriosService : IRelatoriosService {
        ...
        public RelatoriosService(ApplicationDbContext context) {
            _context = context;
        }

        public async Task<List<RelatorioInscricoesViewModel>> RelatorioInscricaoCategoriaId(int idEvento) {
        ...
        public async Task<List<RelatorioTotalInscritosCategoriaInpurModel>> RelatorioTotalInscritosPorCategoria(int idEvento) {
            var inscricoes = _context.Inscricoes
                .AsNoTracking()
                .Include(i => i.Evento)
                .Include(i => i.Atleta)
        ...
        public async Task<List<RelatorioInscricoesViewModel>> RelatorioInscricaoId(int idEvento) {
            var inscricoes = _context.Inscricoes
                .AsNoTracking()
                .Include(i => i.Evento)
                .Include(i => i.Atleta).ThenInclude(a => a.RegistroMedico)
        ...
        public async Task<List<RelatorioTotalInscritosCategoriaInpurModel>> RelatorioTotalInscritosEfetivados(int idEvento) {
            var inscricoes = _context.Inscricoes
                .AsNoTracking()
                .Include(i => i.Evento)
                .Include(i => i.Atleta)
        ...
        public async Task<List<RelatorioTotalCamisasCategoriaInputModel>> RelatorioTotalCamisasCategoria(int idEvento) {
